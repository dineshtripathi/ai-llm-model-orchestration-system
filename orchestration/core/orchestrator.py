...
class ModelOrchestrator:
    ...
    def process_request(self, query: str, priority: str = "balanced", 
                       user_preference: str = None) -> Future:
        """
        ...
        try:
            ...
            selected_model = user_preference if user_preference else routing_decision["selected_model"]
            ...
            failed_future = self.load_balancer.executor.submit(lambda: {
    ...
    def process_request_sync(self, query: str, priority: str = "balanced", 
    ...
    def _update_orchestration_stats(self, routing_time: float, success: bool):
        ...
        if total_successful > 0 and success:
            ...
            self.orchestration_stats["average_routing_time"] = (
                (current_avg * (total_successful - 1) + routing_time) / total_successful
            )
