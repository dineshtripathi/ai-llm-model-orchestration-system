...
class ModelRouter:
    ...
    def analyze_query(self, query: str) -> str:
        ...
        # Coding keywords
        coding_keywords = ['python', 'code', 'function', 'class', 'debug', 'programming', 'script']
        ...
        reasoning_keywords = ['explain', 'complex', 'detailed', 'comprehensive', 'theory']
    ...
    def select_best_model(self, category: str, priority: str = "balanced") -> Optional[str]:
