...
class APICrawler:
    ...
    def comprehensive_crawl(self, search_queries: List[str] = None, use_paid_apis: bool = False) -> Dict:
        """Run all crawlers and ingest data"""
        if search_queries is None:
            search_queries = ["artificial intelligence", "machine learning python", "fastapi tutorial"]
        ...
        if use_paid_apis:
            ...
            if API_KEYS["news_api"]:
                ...
                news_data = self.crawl_news_api(API_KEYS["news_api"], "artificial intelligence")
