...
class DocumentProcessor:
    ...
    def process_directory(self, directory: str, file_extensions: List[str] = ['.txt', '.md']) -> List[Dict]:
...
if __name__ == "__main__":
    ...
    # Test search
    search_results = processor.chroma_manager.search_documents("What is Python used for?", n_results=3)
    print("\nSearch Results:")
